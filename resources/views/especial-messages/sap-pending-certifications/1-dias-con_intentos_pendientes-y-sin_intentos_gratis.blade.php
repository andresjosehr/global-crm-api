...
@foreach ($sapCourses as $course)
Por lo que *estarías perdiendo la posibilidad de realizar el pago por el ponderado* de los exámenes de certificación de ({{$course['name']}}), si no realizas el pago, *dentro de mi horario laboral del día de hoy.*
Y *a partir del envío de este mensaje, el tiempo mínimo para extender ({{$course['name']}}), es de 3 meses.* Y tienes como máximo el plazo de una semana a partir de hoy, para realizar el pago, solo que, el aula que recibirás estará completamente vacía, porque no guardamos tu avance posterior a las 23:59.
