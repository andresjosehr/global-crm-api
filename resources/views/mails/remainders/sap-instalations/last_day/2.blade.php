...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1>¡Tienes un agendamiento pendiente!</h1>
        </div>
        <div class="content">
            ...
            <p>Hemos visto que aun no has agendado tu <strong>{{$instalation_type}}</strong>. Recuerda que es importante que termines de agendar a la brevedad para asegurar un servicio óptimo.</p>
            <p>En este mismo correo te facilitamos el enlace para que puedas agendar tu instalación de SAP.</p>
            <a href="https://terminos.globaltecnoacademy.com/agendamiento-instalacion-sap/{{$sap->key}}" class="button">Agendar Ahora</a>
            <p style="margin-top: 30px">Si tienes alguna duda o necesitas ayuda, no dudes en contactarnos a través de nuestro número oficial de WhatsApp: +51 935355105</p>
        </div>
