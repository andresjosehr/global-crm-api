...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Mañana es el gran día para tu <strong>{{$instalation_type}}</strong>, sin embargo aún no has escogido la hora para tu instalación. Te recordamos que es importante que termines de agendar a la brevedad.</p>
