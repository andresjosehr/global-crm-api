...
<body>
    ...
    <div class="container">
        ...
        <div style="text-align: center">
            ...
            <h1 style='margin: 0px'>SAP INTEGRAL S/4 HANA CON INTRODUCCIÓN A FIORI</h1>
        </div>
        ...
        <div class="seguimiento-academico" style="font-size: 19px">
            ...
            <p>
                <b>¡Te damos la bienvenida a tu curso de SAP INTEGRAL S/4 HANA CON INTRODUCCIÓN A FIORI!</b>
            </p>

            <p>El programa de capacitación de sap comprende <b> 35 HORAS TEÓRICO-PRÁCTICAS CERTIFICADAS COMO INTEGRAL SAP USER.</b></p>
