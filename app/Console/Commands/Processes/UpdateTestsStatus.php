                ...
                try {
                    ...
                    if ($c['course_id'] == 6) {
                        ...
                        if (!$c['end'] && !$c['start']) {
                            ...
                            if (!$c['nivel_basico']['certificate']) {
                                $c['nivel_basico']['certifaction_test'] = '3 Intentos pendientes';
                            }
                            if (!$c['nivel_intermedio']['certificate']) {
                                $c['nivel_intermedio']['certifaction_test'] = '3 Intentos pendientes';
                            }
                            if (!$c['nivel_avanzado']['certificate']) {
                                $c['nivel_avanzado']['certifaction_test'] = '3 Intentos pendientes';
                            }
                        }
                    }
