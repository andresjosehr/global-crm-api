...
class OrdersCoursesController extends Controller
{
    ...
    {
        $orderCourse = OrderCourse::with('course', 'extensions', 'certificationTests', 'sapInstalations.staff', 'sapInstalations.due', 'sapInstalations.lastSapTry', 'freezings', 'dateHistory')->find($id);
        if (!$orderCourse) {
