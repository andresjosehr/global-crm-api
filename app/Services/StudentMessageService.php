...
class StudentMessageService
{
    ...
    public function getMessageForSAPCourseCertification($processDate)
    {
        ...
        Log::debug('StudentMessageService::getMessageForSAPCourseCertification: $sapCourses', $coursesToNotify);
    ...
    public function getMessageForCompletedFreeCourse($processDate)
    {
        try {
            ...
            Log::debug('StudentMessageService::getMessageForCompletedFreeCourse: $message: ' . $message);
            return $message;
        } catch (\Exception $e) {
