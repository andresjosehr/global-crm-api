...
class StudentMessageService
{
    ...
    public function getMessageForSAPCourseCertification($studentData, $processDate)
    {
        ...
        foreach ($studentData['courses'] as $course) :
            ...
            $tmpCertificationPendingAttemptsFlag = strpos($course['certification_test_original'], 'Intentos pendientes');
            $tmpNoFreeCertificationAttemptsFlag = strpos($course['certifaction_test'], 'Sin intentos Gratis');
